<?php
namespace ultimate\util\thirdParty\Net;
use ultimate\util\thirdParty\Net\IDNA2;
// {{{ license
    ...
    private function _nameprep($input)
    {
        ...
        foreach ($input as $v) {
            ...
            if (in_array($v, self::$_np_prohibit) || in_array($v, self::$_general_prohibited)) {
                throw new IDNA2\Exception\Net_IDNA2_Exception_Nameprep('Prohibited input U+' . sprintf('%08X', $v));
            }
