<?php
/**
 * Contains the ContentCommentResponse importer class.
 * 
 * LICENSE:
...
/**
 * Imports content comment responses.
 * 
 * @author		Jim Martens
 * @copyright	2011-2013 Jim Martens
 * @license		http://www.gnu.org/licenses/lgpl-3.0 GNU Lesser General Public License, version 3
 ...
 * @category	Ultimate CMS
 */
class ContentCommentResponseImporter extends AbstractCommentResponseImporter {
	/**
