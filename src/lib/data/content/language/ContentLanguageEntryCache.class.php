<?php
/**
 * Contains ContentLanguageEntryCache class.
 * 
 * LICENSE:
 ...
 * @category	Ultimate CMS
 */
class ContentLanguageEntryCache extends AbstractLanguageEntryCache {
	/**
	 ...
	 * @var string
	 */
	protected static $cacheBuilderClass = '\ultimate\system\cache\builder\ContentLanguageEntryCacheBuilder';
}
