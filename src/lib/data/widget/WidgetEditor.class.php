<?php
/**
 * Contains the widget data model editor class.
 * 
 * LICENSE:
...
/**
 * Provides functions to edit widgets.
 * 
 * @author		Jim Martens
 * @copyright	2011-2012 Jim Martens
 * @license		http://www.gnu.org/licenses/lgpl-3.0 GNU Lesser General Public License, version 3
 ...
 * @category	Ultimate CMS
 */
class WidgetEditor extends DatabaseObjectEditor implements IEditableCachedObject {
	/**
