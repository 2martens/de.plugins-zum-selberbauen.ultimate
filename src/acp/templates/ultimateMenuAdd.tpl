...
<div class="contentNavigation">
    <nav>
        <ul>
            <li><a href="{link controller='UltimateMenuList'}{/link}" title="{lang}wcf.acp.menu.link.ultimate.appearance.menu.list{/lang}" class="button"><img src="{@$__wcf->getPath()}icon/list.svg" alt="" class="icon24" /> <span>{lang}wcf.acp.menu.link.ultimate.menu.list{/lang}</span></a></li>
