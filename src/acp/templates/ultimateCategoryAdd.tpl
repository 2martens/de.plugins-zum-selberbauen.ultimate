...
<header class="mainHeading">
    <img {if $categoryID|isset}id="categoryEdit{@$categoryID}" {/if}src="{@RELATIVE_WCF_DIR}icon/{@$action}1.svg" alt="" />
    <hgroup>
...
<div class="contentHeader">
    <nav>
        <ul class="largeButtons">
            <li><a href="{link controller='UltimateCategoryList'}{/link}" title="{lang}wcf.acp.menu.link.ultimate.category.list{/lang}">{*<img src="{@RELATIVE_WCF_DIR}icon/users1.svg" alt="" /> *}<span>{lang}wcf.acp.menu.link.ultimate.category.list{/lang}</span></a></li>
...
<form method="post" action="{if $action == 'add'}{link controller='UltimateCategoryAdd'}{/link}{else}{link controller='UltimateCategoryEdit'}{/link}{/if}">
    <div class="border content">
        <dl{if $errorField == 'categoryTitle'} class="formError"{/if}>
            ...
            <dd>
               <script type="text/javascript">
                ...
                <input type="text" id="categoryTitle" name="categoryTitle" value="{@$i18nPlainValues['categoryTitle']}" />
        ...
        <dl{if $errorField == 'categorySlug'} class="formError"{/if}>
            ...
            <dd>
                <input type="text" id="categorySlug" name="categorySlug" value="{@$categorySlug}" class="medium" />
        ...
        <dl{if $errorField == 'categoryDescription'} class="formError"{/if}>
            ...
            <dd>
                ...
                <input type="text" id="categoryDescription" name="categoryDescription" value="{@$i18nPlainValues['categoryDescription']}" class="medium" />
