<div id="pageContent" data-controller="ContentAssignToCategoryForm" data-request-type="form" data-ajax-only="true">
    ...
    <form method="post" action="{link application='ultimate' controller='ContentAssignToCategory'}{/link}">
