				...
				{if $content->status == 3}
					<li class="box24">
						...
						<div class="sidebarBoxHeadline">
							<h3><a href="{linkExtended application='ultimate' date=$date contentSlug=$content->contentSlug}{/linkExtended}" {if $content->isVisible} class="ultimateContentLink"{/if} data-content-id="{@$content->contentID}" data-sort-order="DESC" title="{$content->getTitle()}">{$content->getTitle()}</a></h3>
